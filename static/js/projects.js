var consortiumName =
    ...
    projects = [
        ...
        },
        {
            ...
            img:
                "http://depts.washington.edu/labhist/frontpagespecials/230/mapping%20230.jpg"
        },
        {
            ...
            img:
                "http://depts.washington.edu/labhist/frontpagespecials/communism%20project2.jpg"
        },
        {
            title:
            ...
            img:
                "http://depts.washington.edu/labhist/frontpagespecials/IWWhistory.jpg"
        },
        {
            title: "Upton Sinclair's End Poverty in California Campaign",
            url: "http://depts.washington.edu/epic34/",
            img:
                "http://depts.washington.edu/labhist/frontpagespecials/EPIC400.jpg"
        },
        {
            title:
            ...
            img:
                "http://depts.washington.edu/labhist/frontpagespecials/encyclopedia.jpg"
        },
        {
            title: "Labor Press Project",
            url: "http://depts.washington.edu/labhist/laborpress/",
            img:
                "http://depts.washington.edu/labhist/frontpagespecials/LaborPress%20project.jpg"
        },
        {
            title: "America's Great Migrations",
            url: "http://depts.washington.edu/moving1",
            img:
                "http://depts.washington.edu/labhist/frontpagespecials/migrations.jpg"
        }
    ];
...
var projectsListContainer = document.getElementById("navigationProjectsList"),
    projectBoxTemplate = function(url, title, image) {
        return (
            ...
            '<a href="' +
            url +
            '" class="projectBoxImageLink">' +
            '<img src="' +
            image +
            '" alt="' +
            title +
            '" class="projectBoxImage" />' +
            "</a>" +
            '<div class="projectBoxTitle">' +
            '<a class="projectBoxTitleLink" href="' +
            url +
            '">' +
            title +
            "</a>" +
...
for (var i = 0; i < projects.length; i++) {
    projectsHTML =
        projectsHTML +
        projectBoxTemplate(projects[i].url, projects[i].title, projects[i].img);
}
